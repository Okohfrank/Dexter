...
from app.api.deps import get_miso_service, get_publishing_service, get_current_user
...
async def chat_message(
    ...
    if response.is_finalized and response.brief and request.auto_publish and request.connected_account_id:
